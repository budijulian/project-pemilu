        ...
        <div class="col col-sm-12 col-xs-12">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Data Histori</li>
                </ol>
            </section>
            <section class="content">
                ...
                <div class="box">
                     <div class="box-body">
                        ...
                        <div class="box-header ">
                                    ...
                                    <i><a class="btn btn-success" data-toggle="modal" data-target="#tambahdata">
                ...
                <div class="box">
                    ...
                    <small class="text-dark">Data Admin</small>
                        ...
                        <table id="datahistory" class="table table-bordered table-striped" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Periode</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#datahistory').DataTable({ 
        ...
        "ajax": {
          "url": "<?php echo site_url('admin/history/showHistory')?>",
          "type": "POST"
        },
     ...
     $.ajax({
      url : "<?php echo base_url('admin/history/hapusData')?>/"+id,
      type: "POST",
      dataType: "JSON",
