        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <div class="navbar-nav my-2 my-sm-0">
                    <a class="nav-item nav-link active my-2 my-sm-0" href="<?php echo base_url()?>"><strong>
                            HOME</strong></a>
            ...
            <div class="collapse navbar-collapse" style="padding-left:20%;" id="navbarTogglerDemo02">
        ...
        <div class="container" style="padding-top: 30px;">
                ...
                <div id="kandidat" class="carousel-item active">
                    ...
                    <div class="row mt-5" id="ketentuan">
                        ...
                        <br>
                        <div class="card-body">
                            <div class="col col-lg-12 col-sm-12 col-md-12 col-auto embed-responsive">
                                <div class="row">
