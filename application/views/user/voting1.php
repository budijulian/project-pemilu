		...
		<div class="container">
			<div class="row border-0 mt-1 ">
                <div class="col col-12 col-lg-12 col-sm-12 col-md-12 text-center">
                        ...
                        <div id="count_vote_bottom" style="border: 0px solid;" class="col col-12 text-cemter">
...
$(document).ready(function() {
                                ...
                                //  menciptakan date + 4 menit dari waktu cookies
                                 ...
                                 date_add($date, date_interval_create_from_date_string('3 minutes 5 seconds'));
                                 ?>
                                ...
                                setInterval(function () {
                                    ...
                                    var seconds_left = (target_date - current_date) / 1000;
                                       // do some time calculations
                                        ...
                                        if (isNaN(seconds)) {
                                           countdown.innerHTML = "<div></div>";
                                           countdown2.innerHTML="<div></div>";
                                    }else{
